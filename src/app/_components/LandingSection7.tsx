...
export default function LandingSection7() {
  ...
  return (
    <section className="py-24 grid lg:grid-cols-2 gap-y-16">
      ...
      <div className="">
        <h2 className="text-heading-3 md:text-heading-2.5 text-center lg:text-start">We Clean Here!</h2>
        <p className="text-surface-500 mt-4 tracking-wide">Serving your neighborhood with same-day booking and flexible scheduling. See real-time availability in your area.</p>
        ...
        <div className="flex p-4 gap-4 items-start mt-8">
          ...
          <div className="flex-1 space-y-4">
            <p className="text-subtitle text-secondary-700">Don&apos;t see your area?</p>
            ...
            <div className="flex *:flex-1 gap-4 flex-wrap *:min-w-fit">
              ...
              <Button size="xs" variant="default-outline">Call (702) 555-0122</Button>
            </div>
          </div>
        </div>
      </div>

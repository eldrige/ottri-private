...
export default function CookiesBanner() {
  ...
  return (
    <div className={cn("fixed bottom-0 left-0 w-full flex justify-center px-4 z-40 transition-all duration-300", show ? "translate-y-0 visible" : "translate-y-full invisible")}>
      <div className="py-4 px-8 md:p-8 bg-white rounded-t-2xl flex flex-col md:flex-row items-start gap-4 container max-w-4xl shadow-lg shadow-black/25 border-2 border-b-0 border-primary-700">
        ...
        <div>
          <h2 className="text-heading-4 text-secondary-700">We Use Cookies To Improve Your Experience</h2>

          ...
          <div className="lg:mt-24 py-4 px-4 sm:px-6 space-y-4 lg:mr-6.5 rounded shadow-custom">
            ...
            <div className="grid grid-cols-3 text-center">
              <div className="space-y-1">
                <p className="text-subtitle font-medium sm:text-heading-5 text-primary-700">$89</p>
                <p className="text-xs sm:text-caption text-surface-500">1-2 Bedrooms</p>
              </div>
              <div className="space-y-1">
                <p className="text-subtitle font-medium sm:text-heading-5 text-primary-700">$129</p>
                <p className="text-xs sm:text-caption text-surface-500">3-4 Bedrooms</p>
              </div>
              <div className="space-y-1">
                <p className="text-subtitle font-medium sm:text-heading-5 text-primary-700">$169</p>
                <p className="text-xs sm:text-caption text-surface-500">5+ Bedrooms</p>
              </div>
            </div>
            <p className="text-xs text-surface-500 sm:text-center">*Base pricing. Final quote depends on home details & selected services.</p>
          </div>
        </div>
        <figure className="">
            <Image className="ml-auto hidden lg:block" src={figure1} alt="Hero Figure" />
            <Image className="lg:hidden w-full scale-110" src={figure1Mobile} alt="Hero Figure" />
        </figure>
      </section>
  )
}

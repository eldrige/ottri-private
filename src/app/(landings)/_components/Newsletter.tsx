  ...
  return (
    <div className="bg-secondary-700 py-8 md:py-16 flex items-center justify-center mb-24">
      <div className="flex flex-col px-6 md:px-0 text-center items-center gap-2 justify-center">
        <h1 className="text-3xl md:text text-white">
        ...
        <div className="w-full max-w-xl mt-2">
          ...
          >
            <Input
              className="py-3 md:py-3.25 w-full md:flex-2"
              name="email"
              type="text"
              placeholder="Enter your email...."
            />
            <Button
              className="py-2.5 md:flex-1 border-secondary-700 w-full text-white text-lg md:py-3.25 hover:border-primary-700"
              type="submit"
            >
              Subscribe
            </Button>

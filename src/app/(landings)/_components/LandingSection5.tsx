  ...
  const serviceCards = [
    {
      ...
      subtitle: 'Perfect for special occasions, moving, or when you need that extra sparkle.',
      services: [
        "All rooms included",
        "Inside appliances",
        "Detailed cleaning",
    ...
    },
    {
      ...
      subtitle: 'Regular maintenance cleaning to keep your home consistently fresh and tidy.',
      services: [
    ...
    },
    {
      ...
      subtitle: 'Comprehensive cleaning for transitions. Get your deposit back or welcome home in style.',
      services: [
        "Empty home cleaning",
  ...
  return (
    <section className='pb-4 pt-8 lg:py-24 space-y-8'>
      <div className='text-center flex flex-col items-center gap-4'>
        <h2 className='text-heading-3 lg:text-heading-2'>Choose Your Perfect Cleaning Service</h2>
...
function ServiceCard({ Icon, mostPopular, title, subtitle, services, priceFrom, duration, buttonText }: ServiceCardProps) {
  return (
    <div className={cn('relative rounded-lg border-2 border-black/10 space-y-4', mostPopular && "border-primary-700")}>
      ...
      <div className='space-y-4 px-6 py-10'>
        ...
        <Button size="xs" variant={mostPopular ? "default" : "default-outline"} className='w-full px-2'>{buttonText}</Button>
      </div>
    </div>
  );
}
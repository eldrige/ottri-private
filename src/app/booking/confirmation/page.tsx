    ...
    <main className='text-secondary-700'>
      <div className='bg-secondary-700 text-white flex flex-col items-center py-16 space-y-4'>
        ...
        <div className='text-center space-y-2'>
          ...
          <p className='text-subtitle tracking-wide text-surface-100'>Your cleaning service has been successfully scheduled</p>
        </div>
          ...
          <div className='col-span-2 space-y-8'>
            ...
            <div className='p-8 space-y-8 shadow-custom-light rounded-lg'>
              <div className='flex justify-between items-center'>
                ...
                <Badge variant="success-outline" size="sm">Confirmed</Badge>
              </div>
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                <div className='flex gap-4'>
                  ...
                  <div className='space-y-1'>
                    ...
                    <p className='text-caption text-surface-500'>July 15, 2025</p>
                    <p className='text-caption text-surface-500'>10:00AM - 1:00 PM</p>
                  </div>
                </div>
                <div className='flex gap-4'>
                ...
                <div className='flex gap-4'>
                  ...
                  <div className='space-y-1'>
                    ...
                    <p className='text-caption text-surface-500'>Deep House Cleaning</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='space-y-4'>
            ...
            <div className='p-8 space-y-14 shadow-custom-light rounded-lg'>
              ...
              <div className='flex flex-col gap-6'>
                <Button className='flex gap-3 items-center justify-center' size={"xs"} variant={"secondary"}>
                  <PlusIcon className='size-6' />
                  Book Another Cleaning
                </Button>
                <Button className='flex gap-3 items-center justify-center' size={"xs"} variant={"default-outline"}>
        ...
        <ul className='space-y-6'>
          <li className='flex gap-4'>
            ...
            <div className='space-y-2'>
              ...
              <p className='text-surface-500'>Clear surfaces and secure valuables</p>
            </div>
          </li>
          <li className='flex gap-4'>
            <span className='text-lg font-nunito-sans font-bold text-white flex justify-center items-center h-8 aspect-square rounded-full bg-primary-700'>
            ...
            <div className='space-y-2'>
              ...
              <p className='text-surface-500'>We&apos;ll remind you 24 hours before</p>
            </div>
          </li>
          <li className='flex gap-4'>
            <span className='text-lg font-nunito-sans font-bold text-white flex justify-center items-center h-8 aspect-square rounded-full bg-primary-700'>
            ...
            <div className='space-y-2'>
              ...
              <p className='text-surface-500'>Relax while we handle the cleaning</p>
            </div>
          </li>
        </ul>
      </div>
